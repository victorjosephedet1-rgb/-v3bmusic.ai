    ...
    <div className="space-y-8">
      <div className="text-center">
        ...
        <p className="text-xl text-gray-300 max-w-3xl mx-auto">
          V3BMusic.AI is built on trust, security, and fair treatment for all users.
          We protect artists, creators, and the community with industry-leading safety features.
        </p>
      </div>
        ...
        <div className="flex items-start space-x-3">
          ...
          <div>
            ...
            <p className="text-blue-300 mb-4">
              Our AI-powered safety system monitors all transactions, uploads, and user activity in real-time.
              Suspicious activity is flagged instantly, protecting the community before issues escalate.
            </p>
      ...
      <div className="text-center">
        <p className="text-gray-400 text-sm">
          ...
          <a href="mailto:safety@v3bmusic.ai" className="text-cyan-400 hover:text-cyan-300">
            safety@v3bmusic.ai
          </a>
        </p>
      </div>
