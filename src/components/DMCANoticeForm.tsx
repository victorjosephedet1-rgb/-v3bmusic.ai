    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-xl p-6 mb-8">
        <div className="flex items-start space-x-3">
          ...
          <div className="text-sm text-yellow-200">
            ...
            <p>
              Filing a false or fraudulent DMCA notice may result in legal consequences, including monetary damages
              and attorney fees under Section 512(f) of the DMCA. Only file this notice if you are the copyright
      ...
      <form onSubmit={handleSubmit} className="space-y-6 bg-slate-800/50 rounded-xl p-8 border border-white/10">
        ...
        <div className="space-y-4 pt-6 border-t border-white/10">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 mt-2">
              Include details such as title, registration number, publication date, etc.
            </p>
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white focus:outline-none focus:border-purple-500"
              placeholder="https://v3bmusic.ai/..."
            />
            <p className="text-xs text-gray-500 mt-2">
              Provide the exact URL where the infringing content is located on our platform
            </p>
          </div>
        </div>
        ...
        <p className="text-xs text-gray-500 text-center">
          By submitting this form, you agree that the information provided is accurate and complete under penalty of perjury.
          V3BMusic.AI will process this notice in accordance with the Digital Millennium Copyright Act (DMCA).
        </p>
      </form>
    </div>
  );
