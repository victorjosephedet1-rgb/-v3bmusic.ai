  ...
  const loadRoyaltyData = async () => {
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps
      ...
      const royaltyTransactions: RoyaltyTransaction[] = licenses.map(license => {
        const artistShare = license.price_paid * 0.70; // 70% to artist
        const platformFee = license.price_paid * 0.30; // 30% platform fee
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-gradient-to-r from-green-500/10 to-blue-500/10 rounded-xl p-6 border border-green-500/20">
          ...
          <p className="text-green-300 text-sm">70% artist share (industry leading)</p>
        </div>
            ...
            <table className="w-full">
              <thead className="bg-white/5">
                <tr>
                  ...
                  <th className="text-left py-4 px-6 text-sm font-medium text-gray-400">Your Share (70%)</th>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <ul className="text-sm text-blue-200 space-y-1">
              <li>• 70% goes directly to you (industry leading)</li>
