            ...
            <div className="bg-red-500/10 border border-red-500/20 rounded-lg p-4">
              <div className="text-sm text-red-300">
                ...
                <div className="text-red-300/80 space-y-1">
                  <div>• Please provide proof of ownership</div>
                  <div>• Include original work URLs or documentation</div>
                  <div>• False copyright claims may have legal consequences</div>
                </div>
              </div>
            </div>
          )}
