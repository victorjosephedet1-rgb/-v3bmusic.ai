          ...
          <div className="p-6 border-t border-white/10 bg-slate-900/50">
            ...
            <label className="flex items-start space-x-3 mb-4 cursor-pointer">
              ...
              <span className="text-sm text-gray-300">
                I have read and agree to the terms outlined in this {agreement.title}.
                I understand that this agreement is legally binding and will be recorded with a digital signature.
              </span>
            </label>
            ...
            <p className="text-xs text-gray-500 mt-4 text-center">
              By clicking "I Accept", you agree to be legally bound by this agreement.
              Your acceptance will be recorded with timestamp and digital signature for legal compliance.
            </p>
          </div>
        )}
      </div>
